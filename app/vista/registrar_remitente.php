...
<html>
<head>
<title>Remitente de la Nota de Remisi&oacute;n - SISCOR</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<link rel="stylesheet" href="../assets/css/estilo.css" type="text/css"/>
<script type="text/javascript" src="../assets/js/vali_remitente.js"></script> 
</head>
<body>
<center>
<div id="cuerpo"> 
	...
	<div id="sesion"> Bienvenido(a): [<?php  echo ($_SESSION['nombre_user']);?> ] [<a href="../controlador/control_session.php">Cerrar Sesión</a>]</div>
   	<div id="contenedor">
		...
		<br>
			<form class="form2" autocomplete="off" name="frm_remitente" method="post" action="../controlador/control_remitente_nota_remision.php">			
		...
		<fieldset> <legend>Remitente</legend>
					...
					<?php if ($_SESSION['estatus_msj']==1)
						...
						<?php echo ($_SESSION['error_remitente']);?></label></td></tr></table><?php 
						unset($_SESSION['error_remitente']);
			...
			<table align="center" class="tabla" width="650px">
				...
				<tr class="modo1">
					<td width="250px"><label><span class = "font3">* </span>Nombre:</label></td> 
				   	<td><input name="nb_remitente" type="text" maxlength="50" size="60" value ="<?php echo ($_SESSION['nombre_remitente']);?>" ></td>
				</tr>
				<tr class="modo1">
					<td><label><span class = "font3">* </span>Cargo:</label></td> 
				   	<td><input name="nb_cargo" type="text" maxlength="50" size="60" value ="<?php echo ($_SESSION['nombre_cargo']);?>" ></td>
				</tr>
				<tr class="modo1">
               	   		...
               	   		else
                  		{
       			      		...
       			      		if ($_SESSION['modificar']==1 || $_SESSION['eliminar']==1)
							 {
                               ...
                               for ($index = 0; $index < $cantidad; $index++) 
                               {
                                       ...
                                       if ($_SESSION['modificar']==1 && $_SESSION['eliminar']==1 )
                               		   {
                                       	    echo" <td class='font2' align='center'><a href='../controlador/control_acciones.php?form=mod&id=" . $id[$index] . "'>
                                       	    	  <img src='../assets/img/edit.png'  border='0' title='Modificar' ></a>
                                       	    	  <a href='../controlador/control_acciones.php?form=eli&id=" . $id[$index] . "' onClick='return confirma();'>
                                       ...
                                       {
                                       		echo" <td class='font2' align='center'><a href='../controlador/control_acciones.php?form=eli&id=" . $id[$index] . "' onClick='return confirma();'>
                                                  <img src='../assets/img/eliminar.png'  border='0' title='Eliminar' ></a></td></tr>";
                                       }                                
                               }
                               echo "<table>";
		...
		<input name="id_acciones" type="hidden" maxlength="10" size="60" value ="<?php echo ($_SESSION['id_acciones']);?>" >
