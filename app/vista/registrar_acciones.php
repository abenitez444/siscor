...
<html>
<head>
<title>Registro de Acciones - SISCOR</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<link rel="stylesheet" href="../assets/css/estilo.css" type="text/css"/>
<script type="text/javascript" src="../assets/js/vali_acciones.js"></script> 
</head>
<body>
<center>
<div id="cuerpo"> 
	...
	<div id="sesion"> Bienvenido(a): [<?php  echo ($_SESSION['nombre_user']);?> ] [<a href="../controlador/control_session.php">Cerrar Sesión</a>]</div>
   	<div id="contenedor">
		...
		<br>
			<form class="form2" autocomplete="off" name="frm_alto_nivel" method="post" action="../controlador/control_acciones.php">			
	
		<fieldset> <legend>Registro de Acciones</legend>
					...
					<?php if ($_SESSION['estatus_msj']==1)
						...
						<?php echo ($_SESSION['error_acciones']);?>
			...
			<table align="center" class="tabla" width="650px">
				...
				<tr class="modo1">
					<td width="250px"><label><span class = "font3">* </span>Nombre:</label></td> 
				   	<td><input name="nb_acciones" type="text" maxlength="50" size="60" value ="<?php echo ($_SESSION['nombre_acciones']);?>" ></td>
				</tr>
				<tr class="modo1">
