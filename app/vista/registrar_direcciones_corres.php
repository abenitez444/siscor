...
include_once("../modelo/class_direcciones_corres.php");
	...
	$direcciones_corres->registrarFunciones($MiAjax);	

?>
<html>
<head>
<title>Registro de Direcciones Correspondencia - SISCOR</title>
...
<div id="cuerpo"> 
	...
	<div id="sesion"> Bienvenido(a): [<?php  echo ($_SESSION['nombre_user']);?> ] [<a href="../controlador/control_session.php">Cerrar Sesión</a>]</div>
   	<div id="contenedor">
		...
		<br>
			<form class="form2" autocomplete="off" name="frm_alto_nivel" method="post" action="../controlador/control_direcciones_corres.php">			
	
		<fieldset> <legend>Registro de Direcci&oacute;n Correspondencia</legend>
					...
					<?php if ($_SESSION['estatus_msj']==1)
						...
						<?php echo ($_SESSION['error_direcciones_corres']);?></label></td></tr></table><?php 
						unset($_SESSION['error_direcciones_corres']);
			...
			<table align="center" class="tabla">
				...
				<td>
					...
					<?php 
						if ( $_SESSION['primer_nivel_corres'] == "" ) 
						{
						...
						else
						{
							...
							<option value=\"". $_SESSION['primer_nivel_corres'] ."\" selected>". $_SESSION['nombre_primer_nivel_corres'] ."</option>";
							echo "</select>";
							}
					?>
				</div>	
				...
				<tr class="modo1">
					<td><label><span class = "font3">* </span>Nombre:</label></td> 
				   	<td><input name="nb_direcciones" type="text" maxlength="100" size="60" value ="<?php echo ($_SESSION['nombre_direcciones_corres']);?>" ></td>
				</tr>
				<tr class="modo1">
					<td><label>Ubicaci&oacute;n:</label></td> 
				   	<td><input name="ubicacion_direcciones" type="text" maxlength="100" size="60" value ="<?php echo ($_SESSION['ubicacion_direcciones_corres']);?>" ></td>
				</tr>
				<tr class="modo1">
					<td><label>Edificio:</label></td> 
				   	<td><input name="edificio_direcciones" type="text" maxlength="50" size="60" value ="<?php echo ($_SESSION['edificio_direcciones_corres']);?>" ></td>
				</tr>
				<tr class="modo1">
					<td><label>Piso:</label></td> 
				   	<td><input name="piso_direcciones" type="text" maxlength="2" size="60" value ="<?php echo ($_SESSION['piso_direcciones_corres']);?>" onKeyPress="return solo_num(event)" ></td>
				</tr>				
				<tr class="modo1">
					<td><label>Tel&eacute;fono:</label></td> 
				   	<td><input name="telefono_direcciones" type="text" maxlength="50" size="60" value ="<?php echo ($_SESSION['telefono_direcciones_corres']);?>" ></td>
				</tr>
				<tr class="modo1">
					<td><label>Observaci&oacute;n:</label></td> 
				   	<td><textarea name="observacion_direcciones" cols="60" rows="3"><?php echo ($_SESSION['observacion_direcciones_corres']);?></textarea></td>
				</tr>
				<tr class="modo1">
		...
		<input name="id_primer_nivel" type="hidden" maxlength="10" size="60" value ="<?php echo ($_SESSION['primer_nivel_corres']);?>" >
