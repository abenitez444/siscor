...
<script type="text/javascript" src="../assets/js/vali_reportes_oficios_respuesta.js"></script> 
...
<div id="cuerpo"> 
	...
	<div id="central">
		<br>
		<form class="form" autocomplete="off" name="frm_reportes_oficios_respuesta" method="post" action="../controlador/control_reportes_oficios_respuesta.php">	
			...
			<table align="center" class="tabla" width="650px">
				<tr class="modo1">
					<td><label class="label_class">
							<input name="consul_oficios" type="radio" value="respuesta" onClick="activa_opcion(value)" > 
							<span id='respondidos' class = "font3" style='visibility:hidden'>* </span>
							Respondidos:</label></td>
					<td><?php 
				   	echo "<select  name=\"resp\" id=\"resp\" disabled=\"disabled\" >";
				...
				<tr class="modo1"> 
	    			<td><label class="label_class">                                                        
	    			<input name="consul_oficios" type="radio" value="num_correlativo" onClick="activa_opcion(value)" >
				...
				<tr class="modo1">
					<td>
						<label class="label_class">
			    		<input name="consul_oficios" type="radio" value="fecha" onClick="activa_opcion(value)">
