...
<script type="text/javascript" src="../assets/js/vali_reportes_remisiones_general.js"></script> 
...
<div id="cuerpo"> 
	...
	<div id="central">
		<br>
		<form class="form" autocomplete="off" name="frm_reportes_remisiones" method="post" action="../controlador/control_reportes_remisiones_general.php">	
		...
		<span >
			...
			<table align="center" class="tabla" width="650px">
				...
				<tr class="modo1">
					...
					<input name="consul_remisiones" type="radio" value="direccion" onClick="activa_opcion(value,dire_user.value,perf_user.value)">
				...
				<?php if ($_SESSION['direcciones_user']!=0)
				   			{?>
				<tr class="modo1">
                        ...
                        if($_SESSION['coordinaciones_user']!="")
						{
							/*if ($_SESSION['coordinaciones_user']==0)
				   			...
				   			else 
				   			{
								...
								echo "<label><select  name=\"coordinaciones\" id=\"coordinaciones\" ".$_SESSION['disabled']." >";
								...
								echo ("</select>");
								echo " <input name='todos_coord' type='checkbox' disabled='disabled'
								onclick='coordinaciones.disabled = this.checked;coordinaciones.selectedIndex=0'>
								Todas las Coordinaciones</label>";								
							}
					    	else
						   	{
						   	echo "<select name=\"coordinaciones\" id=\"coordinaciones\" disabled=\"disabled\"><option value=\"0\">-Seleccione una Direcci&oacute;n-</option></select>	
						   		  <input name=\"check_todos_coordinaciones\" type=\"checkbox\" disabled=\"disabled\">   Todas las Coordinaciones</label>	";
						   	}
					?>
				</div></td>
				<?php }?>
