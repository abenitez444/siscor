...
<html>
<head>
<title>Registro de Clasificaci&oacute;n de Documentos - SISCOR</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<link rel="stylesheet" href="../assets/css/estilo.css" type="text/css"/>
<script type="text/javascript" src="../assets/js/vali_clasificacion_documentos.js"></script> 
</head>
<body>
<center>
<div id="cuerpo"> 
	...
	<div id="sesion"> Bienvenido(a): [<?php  echo ($_SESSION['nombre_user']);?> ] [<a href="../controlador/control_session.php">Cerrar Sesión</a>]</div>
   	<div id="contenedor">
		...
		<br>
			<form class="form2" autocomplete="off" name="frm_alto_nivel" method="post" action="../controlador/control_clasificacion_documentos.php">			
	
		<fieldset> <legend>Registro de Clasificaci&oacute;n de Documentos</legend>
					...
					<?php if ($_SESSION['estatus_msj']==1)
						...
						<?php echo ($_SESSION['error_clasificacion_documentos']);?></label></td></tr></table><?php 
						unset($_SESSION['error_clasificacion_documentos']);
			...
			<table align="center" class="tabla" width="650px">
				...
				<tr class="modo1">
					<td width="250px"><label><span class = "font3">* </span>Nombre:</label></td> 
				   	<td><input name="nb_clasificacion_documentos" type="text" maxlength="50" size="60" value ="<?php echo ($_SESSION['nombre_clasificacion_documentos']);?>" ></td>
				</tr>
				<tr class="modo1">
				...
				if ($_SESSION['ingresar']==0 && $_SESSION['modificar']==1)
				{
			 	...
			 	if ($_SESSION['modi']==1)
			 	{
					...
					<tr class="modo1">
				   	...
				   	<?php	
				   if($_SESSION['id_clasificacion_documentos'] =="")
				   {
       			      ...
       			      echo  "<br>	
       			      		...
       			      		if ($_SESSION['modificar']==1 || $_SESSION['eliminar']==1)
							 {
                               ...
                               for ($index = 0; $index < $cantidad; $index++) 
                               {
                               		...
                               		if ($_SESSION['modificar']==1 && $_SESSION['eliminar']==1)
                               		{
		                               			echo" <td class='font2' align='center'>
			                               			      
		                               					  <a href='../controlador/control_clasificacion_documentos.php?form=mod&id=" . $id[$index] . "'>
			                               				  <img src='../assets/img/edit.png'  border='0' title='Modificar' >
			                               				  </a>
									   					  <a href='../controlador/control_clasificacion_documentos.php?form=eli&id=" . $id[$index] . "' onClick='return confirma();'>
			                                       	      <img src='../assets/img/eliminar.png'  border='0' title='Eliminar' >
			                                       	      </a></td></tr>"; 
			                               		}
		...
		<input name="id_clasificacion_documentos" type="hidden" maxlength="10" size="60" value ="<?php echo ($_SESSION['id_clasificacion_documentos']);?>" >
