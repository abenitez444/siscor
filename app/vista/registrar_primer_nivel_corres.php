...
include_once("../modelo/class_primer_nivel_corres.php");
	...
	$primer_nivel_corres->registrarFunciones($MiAjax);	
...
<div id="cuerpo"> 
	...
	<div id="sesion"> Bienvenido(a): [<?php  echo ($_SESSION['nombre_user']);?> ] [<a href="../controlador/control_session.php">Cerrar Sesión</a>]</div>
   	<div id="contenedor">
		...
		<br>
			<form class="form2" autocomplete="off" name="frm_alto_nivel" method="post" action="../controlador/control_primer_nivel_corres.php">			
	
		<fieldset> <legend>Registro de Primer Nivel Correspondencia</legend>
					...
					<?php if ($_SESSION['estatus_msj']==1)
						...
						<?php echo ($_SESSION['error_primer_nivel_corres']);?></label></td></tr></table><?php 
						unset($_SESSION['error_primer_nivel_corres']);
			...
			<table align="center" class="tabla">
				...
				<tr class="modo1">
					<td><label><span class = "font3">* </span>Alto Nivel: </label></td> 
				   	...
				   	echo "<select ".$_SESSION['disabled']." name=\"alto_nivel\" id=\"alto_nivel\" onchange=\"xajax_llenarPrimerNivel(document.getElementById('alto_nivel').value,".$_SESSION['direcciones_user'].",".$_SESSION['alto_nivel_user'].",".$_SESSION['primer_nivel_user'].");return false;\">";
				   		...
				   		for ($index = 0; $index < $cantidad; $index++) 
                							{
                								...
                								//echo("<option value= \"$id[$index]\"  if ($valor== \"$id[$index]\") 'selected'; >$nombre[$index]</option>");
				...
				<tr class="modo1">
					<td><label><span class = "font3">* </span>Nombre:</label></td> 
				   	<td><input name="nb_primer_nivel" type="text" maxlength="100" size="60" value ="<?php echo ($_SESSION['nombre_primer_nivel_corres']);?>" ></td>
				</tr>
				<tr class="modo1">
					<td><label>Ubicaci&oacute;n:</label></td> 
				   	<td><input name="ubicacion_primer_nivel" type="text" maxlength="100" size="60" value ="<?php echo ($_SESSION['ubicacion_primer_nivel_corres']);?>" ></td>
				</tr>
				<tr class="modo1">
					<td><label>Edificio:</label></td> 
				   	<td><input name="edificio_primer_nivel" type="text" maxlength="50" size="60" value ="<?php echo ($_SESSION['edificio_primer_nivel_corres']);?>" ></td>
				</tr>
				<tr class="modo1">
					<td><label>Piso:</label></td> 
				   	<td><input name="piso_primer_nivel" type="text" maxlength="2" size="60" value ="<?php echo ($_SESSION['piso_primer_nivel_corres']);?>" onKeyPress="return solo_num(event)" ></td>
				</tr>				
				<tr class="modo1">
					<td><label>Tel&eacute;fono:</label></td> 
				   	<td><input name="telefono_primer_nivel" type="text" maxlength="50" size="60" value ="<?php echo ($_SESSION['telefono_primer_nivel_corres']);?>" ></td>
				</tr>
				<tr class="modo1">
					<td><label>Observaci&oacute;n:</label></td> 
				   	<td><textarea name="observacion_primer_nivel" cols="60" rows="3"><?php echo ($_SESSION['observacion_primer_nivel_corres']);?></textarea></td>
				</tr>
				<tr class="modo1">
		...
		<input name="id_primer_nivel" type="hidden" maxlength="10" size="60" value ="<?php echo ($_SESSION['id_primer_nivel_corres']);?>" >
