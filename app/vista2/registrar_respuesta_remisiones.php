...
<script type="text/javascript" src="../assets/js/vali_respuesta_remisiones.js"></script> 
...
<div id="cuerpo"> 
	...
	<div id="central">
		<br>
		<form class="form" autocomplete="off" name="frm_remisiones" method="post" action="../controlador/control_respuesta_remisiones.php">	
		<fieldset>
		<legend>
		<?php if($_SESSION['RespuestaOficio']==2)
		{
		?>
		Consultar Respuesta
		<?php 
		...
		<span>
			...
			<table align="center" class="tabla" width="650px" >
				<tr class="modo1"  > 
							...
							{
							?>
							Por favor incluya el N&uacute;mero del Oficio Recibido a Consultar
							<?php 
							}
							else
							{
							?>
							Por favor incluya el N&uacute;mero de Remisi&oacute;n al cual desea asignar la respuesta
							<?php
							} 
							?>
				...
				<tr class="modo1">		
					...
					<?php/* if ($_SESSION['consul_oficio']==1)
							{*/
					?>
						<!-- <input class="boton" type="submit" name="cancelar_remisiones" value="Cancelar" >
