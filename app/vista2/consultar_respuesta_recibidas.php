...
<div id="cuerpo"> 
	...
	<div id="central">
		<br>
		<form class="form" autocomplete="off" name="frm_recibidas" method="post" action="../controlador/control_consul_respuesta_recibidas.php">	
		<fieldset> <legend>Consultar Respuesta</legend>	
		<span >
        				<?php
			...
			<table align="center" class="tabla" width="650px">
				<tr class="modo1"  > 
			    			...
			    			Por favor incluya el N&uacute;mero del Oficio Recibido a consultar</label></td>
			    			<!--
			    			<td colspan="2" align="center"><label class="label_class">                                                        
			    			Por favor incluya el N&uacute;mero del Oficio Recibido de Respuesta</label></td>
