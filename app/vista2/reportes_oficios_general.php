...
?>
<title>Reportes Oficios Enviados - SISCOR</title>
...
<script type="text/javascript" src="../assets/js/vali_reportes_oficios_general.js"></script> 
...
<div id="cuerpo"> 
	...
	<div id="central">
		<br>
		<form class="form" autocomplete="off" name="frm_reportes_oficios_general" method="post" action="../controlador/control_reportes_oficios_general.php">	
		<fieldset> <legend>Reportes Oficios Enviados </legend>	
		<span>
        				<?php
			...
			<table align="center" class="tabla" width="650px">
				...
				<tr class="modo1">
					<td><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id='primernivel' class = "font3" style='visibility:hidden'>* </span>Primer Nivel:</label></td>
					<td>
			   	...
			   	if ($_SESSION['activo']==1)
			   	{
				   	...
				   	for ($index = 0; $index < $cantidad; $index++) 
                	{
						...
						<table>
							<tr>
								<td>	
									<a href='pdf_oficios_general.php'><img src='../assets/img/pdf.jpg' align='center' border='0' title='Imprimir' width='40' height='40'></a>
									&nbsp;&nbsp;																	
								</td>
								<td>
									&nbsp;&nbsp;	
									<a href='excel_oficios_general.php'><img src='../assets/img/excel.png' align='center' border='0' title='Imprimir' width='40' height='40'></a>
								</td>
							</tr>
						</table>";
                	}
