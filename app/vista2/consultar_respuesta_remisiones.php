...
<div id="cuerpo"> 
	...
	<div id="central">
		<br>
		<form class="form" autocomplete="off" name="frm_recibidas" method="post" action="../controlador/control_consul_respuesta_remisiones.php">	
		...
		<span>
			...
			<table align="center" class="tabla" width="650px" >
				<tr class="modo1"  > 
			    			...
			    			Por favor incluya el N&uacute;mero de la Remisi&oacute;n a consultar</label></td>
				...
				<tr class="modo1">		
					...
					<td colspan="2" align="center">
						...
						<!-- <input class="boton" type="submit" name="cancelar_recibidas" value="Cancelar" onClick="return valida(this);blockEnter = true;"  >
						 -->
					</td>
		</table>
	</fieldset>
