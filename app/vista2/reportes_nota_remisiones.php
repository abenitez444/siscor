...
include("input.php");	
?>
<title>Reportes Nota de Remisiones - SISCOR</title>
...
<div id="cuerpo"> 
	...
	<div id="central">
		<br>
		<form class="form" autocomplete="off" name="frm_reportes_remisiones_respuesta" method="post" action="../controlador/control_reportes_nota_remisiones.php">	
		 
		<fieldset> <legend>Reportes Nota de Remisiones </legend>	
		<span>
        				<?php
			...
			if ($_SESSION['activo']==1)
			   	{
					...
					echo "</table>
					<br>	
					<a href='pdf_nota_remisiones.php'><img src='../assets/img/pdf.jpg' align='center' border='0' title='Imprimir' width='40' height='40'  >Imprimir</a>
					</div>";
