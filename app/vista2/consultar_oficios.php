...
?>
<title>Consultar Oficios Enviados - SISCOR</title>
...
<script type="text/javascript" src="../assets/js/vali_consultar_oficios.js"></script> 
...
<div id="cuerpo"> 
	...
	<div id="central">
		<br>
		<form class="form" autocomplete="off" name="frm_oficios" method="post" action="../controlador/control_consultar_oficios.php">	
		<fieldset> <legend>Consultar Oficios Enviados </legend>	
		<span>
        				<?php
						...
						<?
						echo ($_SESSION['error_oficios']);
						?></label></td></tr></table><? 
						unset($_SESSION['error_oficios']);
			...
			<table align="center" class="tabla" width="650px">
			    			...
			    			<td>
			    				<label class="label_class">  
			    					<span id='anioconsulta' class = "font3" style='visibility:hidden'>*</span>
						    			A&ntilde;o que desea Consultar:
					    			</label>
			    			</td>
				...
				<tr class="modo1">
			    			...
			    			<input name="consul_oficios" type="radio" value="num_correlativo" onClick="activa_opcion(value,tmp_altonivel.value)" >
				...
				<tr class="modo1">
					<td><label class="label_class">
			    			<input name="consul_oficios" type="radio" value="num_remision" onClick="activa_opcion(value,tmp_altonivel.value)"> 
			    			<span id='nuremision' class = "font3" style='visibility:hidden'>*</span>
			    			N° Remisi&oacute;n:</label></td>
					<td><input name="num_remision" type="text" maxlength="20" size="60" disabled="disabled" "></td>
				</tr>
				
				<tr class="modo1">
					<td>
						<label class="label_class">
			    		<input name="consul_oficios" type="radio" value="fecha" onClick="activa_opcion(value,tmp_altonivel.value)"> 
				...
				<tr class="modo1">
			    			<td><label class="label_class">
			    			<input name="consul_oficios" type="radio" value="destinatarios" onClick="activa_opcion(value,tmp_altonivel.value)">
			    			<span id='destinatario' class = "font3" style='visibility:hidden'>*</span>
			    			Destinatarios:</label></td>
			    			<td><input name="destinatario" type="text" maxlength="30"  size="60" disabled="disabled" ></td>
				</tr>
				<tr class="modo1">
					<td>
						<label class="label_class">
							<input name="consul_oficios" type="radio" value="direccion" onClick="activa_opcion(value,tmp_altonivel.value)"> 
						<span id='altonivel' class = "font3" style='visibility:hidden'>* </span>Alto Nivel:</label></td>
				...
				<tr class="modo1">
					<td><label>
					&nbsp;&nbsp;&nbsp;&nbsp;<span id='primernivel' class = "font3" style='visibility:hidden'>* </span>Primer Nivel:</label></td>
					<td>
					<div id="div_primer_nivel">
				   	...
				   	if($_SESSION['primer_nivel_corres_seleccionado']!="" || $_SESSION['alto_nivel_user']>=25)
			   		{
				   		...
				   		echo "<select  name=\"primer_nivel\" id=\"primer_nivel\" disabled=\"disabled\" onchange=\"xajax_llenarDireccion(document.getElementById('primer_nivel').value,".$_SESSION['direcciones_user'].",".$_SESSION['alto_nivel_user'].",".$_SESSION['primer_nivel_user'].");return false;\" >";
				...
				<tr class="modo1">		
			   	...
			   	if ($_SESSION['activo']==1)
			   	{
					...
					echo"<div  id='contiene_tablas'>
					     ...
					     <tr class='modo1' align='center'><td class='font2' ><label>N&uacute;m.</label></td><td><label>Fecha</label></td><td><label>Alto Nivel</label></td><td><label>Primer Nivel</label></td><td><label>Direcciones</label></td><td><label>Asunto</label></td><td><label>Modificar</label></td>";
				   	for ($index = 0; $index < $cantidad; $index++) 
                	{
						...
						echo "<tr class='modo1'><td class='font2' >" . $id[$index] . "</td><td class='font2'>".$Oficios->devuelve_fecha($fecha[$index])."</td><td class='font2'>".$alto_nivel[$index]."</td><td class='font2'>".$primer_nivel[$index]."</td><td class='font2'>".$campo."</td><td class='font2'>".$asunto[$index]."
						</td><td class='font2' align='center'><a href='../controlador/control_consultar_oficios.php?id=" . $id[$index] . "&mod=1&a=".$anio[$index]."'><img src='../assets/img/edit.png' align='center' border='0' title='Modificar' ></a>";
					}
                	}
                	else
                	{
