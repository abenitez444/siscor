...
<div id="cuerpo"> 
	...
	<div id="central">
		<br>
		<form class="form" autocomplete="off" name="frm_recibidas" method="post" action="../controlador/control_consul_respuesta_oficios.php">	
		...
		<span >
			...
			<table align="center" class="tabla" width="650px">
				<tr class="modo1"  > 
				    ...
				    Por Favor incluya el N&uacute;mero del Oficio a consultar</label></td>
				</tr>
				<tr class="modo1"> 
