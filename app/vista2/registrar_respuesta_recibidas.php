...
<div id="cuerpo"> 
	...
	<div id="central">
		<br>
		<form class="form" autocomplete="off" name="frm_recibidas" method="post" action="../controlador/control_respuesta_recibidas.php">	
		<fieldset>
		<legend>
		...
		<span >
			...
			<table align="center" class="tabla" width="650px">
				<tr class="modo1"  > 
							...
							{
							?>
							Por favor incluya el N&uacute;mero del Oficio Recibido al cual desea asignar la respuesta
							<?php
							} 
							?>
