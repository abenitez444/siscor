...
if($_POST['modificar']==true)
{
	...
	if($_SESSION['perfil']==1)
	{
		...
		//die($Remisiones->getAlto_nivel()." a");
...
/*********************************************************************************************************************************************************/	
    ...
    if ($_SESSION['perfil']==1)
    {
        if ($_POST['id_remitir']!="")
        {
            //Respuesta-remision registrar chequea el recibido a remitir
            $Remisiones->setAnio_recibidas($_POST['anio_remitir']);
            $Remisiones->setId_recibidas($_POST['id_remitir']);
            $_SESSION['anio_remitir_remision']=$_POST['anio_remitir'];
            $_SESSION['id_remitir_remision']=$_POST['id_remitir'];
            ...
            if($_SESSION['check_t']=="on")
            {
                ...
                $_SESSION['check_t']=true;
            }
            else
            {
                $_SESSION['check_t']=false;
            }        
            $_SESSION['check_amerita_respuesta_remision']=$_POST['amerita_respuesta'];
            if($_SESSION['check_amerita_respuesta_remision']=="on")
            {

                $_SESSION['check_amerita_respuesta_remision']=true;
            }
            else
            {
                $_SESSION['check_amerita_respuesta_remision']=false;
            }
            $_SESSION['observacion_remision']=($_POST['observacion']);	
            $_SESSION['Coordinaciones_seleccionado_remision']=($_POST['coordinaciones']);
            $_SESSION['nombre_responsable_remision']=($_POST['nombre_responsable']);
            ...
            {
                $_SESSION['alto_nivel_seleccionado_remision']=($_POST['alto_nivel']);
               // die($_SESSION['alto_nivel_seleccionado_remision']." a");
                $_SESSION['primer_nivel_seleccionado_remision']=($_POST['primer_nivel']);
                $_SESSION['direcciones_seleccionado_remision']=($_POST['direcciones']);
            }
        ...
        {
            //Respuesta-remision consultar chequea el recibido a responder
            $Remisiones->setAnio_recibidas($_POST['anio_respuesta']);
            $Remisiones->setId_recibidas($_POST['id_respuesta']);   
    ...
    if ($_SESSION['perfil']==3)
    {
        ...
        $_SESSION['respondida_observacion_remision']=($_POST['respondida_observacion']);
        $_SESSION['nombre_responsable_remision']=($_POST['nombre_responsable']);
        //die($_SESSION['nombre_responsable_remision']." aaa");
    }
...
//die(" sql");
    if ( $cont != 0 ) 
    {
       ...
       // $Recibidas->setId($_POST['id_respuesta']);
       // $Recibidas->setNuano($_POST['anio_respuesta']);     
        ...
        $Recibidas->setId_primer_nivel_user($_SESSION['primer_nivel_user']);
            ...
            if ($_SESSION['primer_nivel_user']==329)
            {
                $sw=3;//tabla del organigra con corres(alto_nivel_corres)
            }
            else
            {
                $sw=0;
...
//echo($cant); die;
            ...
            if ($_SESSION['primer_nivel_corres_seleccionado']!="")
            {
                ...
                else
                {
                    if ($_SESSION['primer_nivel_user']==329)
                    {
                        if($_SESSION['alto_nivel_corres_seleccionado']==2)
                        {
                            $valor="cd_alto_nivel_corres=2 and cd_primer_nivel_corres < 144";
                        }
                        else
                        {
...
//echo($cant); die;
            ...
            {
                $valor="cd_primer_nivel_corres=".$_SESSION['primer_nivel_seleccionado']." and cd_alto_nivel_usuarios=".$_SESSION['alto_nivel_user']." and cd_primer_nivel_usuarios=".$_SESSION['primer_nivel_user']." and cd_direcciones_usuarios=".$_SESSION['direcciones_user'];
...
if ($_POST['regresar']==true)
{
	...
	unset($_SESSION['bloquear_ConsulRespuestaRemisiones']);
        unset($_SESSION['campoIddirecciones']);
        unset($_SESSION['campoNombredirecciones']);
        unset($_SESSION['cantidaddirecciones']);
        /**/
        unset($_SESSION['nombre_responsable_remision']);
        unset($_SESSION['prioridades_seleccionado_remision']);
        unset($_SESSION['accion_seleccionado_remision']);
    ...
    { 
        if ($_SESSION['primer_nivel_user']==329)
        {
         ...
         else
         {
             ...
             //$valor="cd_alto_nivel=".$_SESSION['alto_nivel_user'];//Usuario perfil direccion toma el valor del id del usuario
