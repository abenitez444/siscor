...
include_once("../modelo/class_modulosxusuarios.php");
	...
	$intPermisoConsultar =$Modulosxusuarios->Existe($Recibidas->getId_usuario(),'in_consultar',"TRUE",3);
	

	$intPermisoModificar =$Modulosxusuarios->Existe($Recibidas->getId_usuario(),'in_modificar',"TRUE",3);
...
if ($_SESSION['RespuestaOficio']!=1 && $_SESSION['RespuestaOficio']!=2 )
{
	$_SESSION['consul']=1;	
