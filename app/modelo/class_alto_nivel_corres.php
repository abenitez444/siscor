    ...
    function Mostrar( $op ) 
		{
			...
			$sql= "SELECT * FROM vista_mostrar_alto_nivel_corres where cd_alto_nivel_corres <> 3 and cd_alto_nivel_usuarios=".$alto_nivel_user." and cd_primer_nivel_usuarios=".$primer_nivel_user." and cd_direcciones_usuarios=".$direcciones_user." order  by nb_alto_nivel_corres";
