                       ...
                       if (pg_num_rows ($Resultado) == 0) {
							...
							<td class='font1'>Opciones</td>";
                               ...
                               while ( $row = pg_fetch_array ( $Resultado ) ) {
                                       $salida .= "<tr class='modo1'><td class='font2'>" . $row ["nb_primer_nivel_corres"] . "</td><td class='font2' align='center'><a href='../controlador/control_primer_nivel_corres.php?form=mod&id=" . $row ["cd_primer_nivel_corres"] . "&idd=".$row['cd_direcciones_usuarios']."'><img src='../assets/img/edit.png'  border='0' title='Modificar' ></a>
                                       <a href='../controlador/control_primer_nivel_corres.php?form=eli&id=" . $row ["cd_primer_nivel_corres"] . "&idd=".$row['cd_direcciones_usuarios']."' onClick='return confirma();'>
